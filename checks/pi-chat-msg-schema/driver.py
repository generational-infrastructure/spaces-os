    ...
    try:
        ...
        check_record(
            ...
            conf,
            {
                ...
                "state": "sent",
                "type": "confirm",
                "confirmTitle": "Run shell command?",
        ...
        check(
            "isPlainAssistant(legacy no-type)", call("isPlainAssistant", legacy), True
        )
        ...
        check(
            "isPendingPrompt(state absent → pending)",
            call("isPendingPrompt", nostate),
            True,
        )
        ...
        check(
            "visible hides thinking", call("visible", msgs, False), [asst, user, legacy]
        )
        ...
        check(
            "patch missing id identity", call("patch", arr, "nope", {"state": "x"}), arr
        )
        ...
        check(
            "appendDelta missing id identity",
            call("appendDelta", arr, "nope", "x"),
            arr,
        )
